...
**Techstack** - React, HTML, CSS, Node.js, Express.js, Python, C, JavaScript
...
Open your browser and navigate to `http://localhost:5178` to view the website.
